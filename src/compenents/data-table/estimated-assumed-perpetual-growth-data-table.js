...
const columns = [
  ...
  {field: "time", headerName: 'Time(24)', width: 80, headerClassName: 'table-header-bg'},
  {field: "all_in_millions", headerName: 'All in Millions', width: 150, headerClassName: 'table-header-bg'},
  ...
  {field: "perpetual_growth_rate", headerName: 'Perpetual Growth Rate', width: 130, headerClassName: 'table-header-bg'},
