    ...
    <React.Fragment>
      <nav className="navbar navbar-expand-lg navbar-light nav-main">
        <div className="container">
          ...
          {
              isSmallDevice ? <NavLinkSmallDevices userID={userID} /> : <NavLinkLargeDevices userID={userID} />
          }
